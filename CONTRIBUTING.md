...
3. An issue is opened to discuss any significant work - we would hate for your time to be wasted.

To send us a pull request, please:

1. Fork the repository.
2. Modify the source; please focus on the specific change you are contributing. If you also reformat all the code, it will be challenging for us to focus on your change.
3. Ensure local tests pass -> `make test`
4. And the linter -> `make lint`
5. Build the project -> `make release-snapshot`
